...
*Owner choice:* Adopt exact PR `autofix` only; Sol first, Terra second, Luna correction/validation/one normal commit/one non-force push, restart at Sol after every push, and parent-only confirmed source-finding replies.
