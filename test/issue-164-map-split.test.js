...
const MOVED_RULE_TEXT_SHA256 = '4493d73b4baba354a34f7f03a4472027c13b0095498b0fbc85b9c8734b6f24e1';
...
test('Issue #164 the moved rule text is the moved rule text, byte for byte', () => {
  ...
  assert.equal(Buffer.byteLength(moved), 12850, 'the map is the size this commit left it');
