...
const MOVED_RULE_TEXT_SHA256 = 'a1a8f5882586ef6a63b14950bdfea26448252eb58e20552504f64c6c33c7cac4'; // CL-D90 (Issue #184) moved the schema out of the expectation row
...
test('Issue #164 the moved rule text is the moved rule text, byte for byte', () => {
  ...
  assert.equal(Buffer.byteLength(moved), 14409, 'the map is the size this commit left it');
