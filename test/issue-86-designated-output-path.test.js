...
test('Issue #86 the transport section names the designated output and its read path', () => {
  ...
  assert.match(section, /a validated envelope at that path is the verdict whatever the runner's status says; a failed validation there is terminal exactly as before/);
});
