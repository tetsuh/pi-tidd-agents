...
// A test that needs the checkout copies what Git tracks and nothing else (Issue #175): the reviewed checkout
// also holds pi's runtime roots `.pi/` and `.pi-subagents/`, which review-only must never read, and ignored or
