...
// CL-D89 adds GIT_CONFIG (a whole-file replacement the GIT_CONFIG_ prefix misses), GIT_NAMESPACE (it moves every ref a
// push writes), and the TLS and HTTP transport variables (they let a credential reach another peer).
const DROP_ENV = /^(?:GIT_TRACE.*|GIT_CONFIG_|GIT_DIR$|GIT_COMMON_DIR$|GIT_WORK_TREE$|GIT_INDEX_FILE$|GIT_OBJECT_DIRECTORY$|GIT_ALTERNATE_OBJECT_DIRECTORIES$|GIT_ALLOW_PROTOCOL$|GIT_ASKPASS$|SSH_ASKPASS$|GIT_SSH$|GIT_SSH_COMMAND$|GIT_SSH_VARIANT$|GIT_PROXY_COMMAND$|GIT_EXTERNAL_DIFF$|GIT_DIFF_OPTS$|GIT_PAGER$|PAGER$|GIT_EDITOR$|GIT_SEQUENCE_EDITOR$|GIT_EXEC_PATH$|GIT_CEILING_DIRECTORIES$|GIT_OPTIONAL_LOCKS$|GIT_CONFIG_NOSYSTEM$|GIT_CONFIG_GLOBAL$|GIT_CONFIG_SYSTEM$|GIT_CONFIG$|GIT_NAMESPACE$|GIT_SSL_.*|GIT_HTTP_.*|GIT_CURL_.*|CURL_CA_BUNDLE$|SSL_CERT_FILE$|SSL_CERT_DIR$)/i;
